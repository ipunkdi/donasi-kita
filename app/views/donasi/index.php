...
<div class="mt-5 mb-4">
    <div class="p-3 text-center">
        <div class="container py-3">
            <h1 class="text-body-emphasis">Donasi</h1>
...
<div class="album pb-5">
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <?php foreach($data['dns'] as $dns) : ?>
                <div class="col">
                    <div class="card shadow-sm">
                        <div class="card-body">
                                <li class="list-group-item d-inline justify-content-between align-items-center">
                                <img src="<?= BASEURL; ?>/img/<?= $dns['gambar']; ?>" alt="album" class="img-fluid" width="100%" height="225">
                                    <h4><?= $dns['jenis']; ?></h4>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group col mx-auto mt-2">
                                            <a href="<?= BASEURL; ?>/donasi/detail/<?= $dns['id']; ?>" class="btn btn-primary btn-block">
                                            View
                                            </a>
                                        </div>
                                    </div>
