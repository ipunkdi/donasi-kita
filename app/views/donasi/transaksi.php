...
<body>
    <section class="blog-section section-gap-bottom" style="padding-top: 20px; background: #f9f9f9;">
        <div class="container">
            ...
            <h6 class="text-center mt-5" style="font-size: 12px;"><b>Donasi</b></h6>
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6" id="content-donation">
                    <form action="<?= BASEURL; ?>/donasi/transaksi" method="post" class="form-horizontal box-payment-donation" role="form" id="form-donation">
                        <div class="">
                            ...
                            <div class="form-group other-amount" id="other-amount">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control" placeholder="0" value="" aria-haspopup="true" aria-expanded="false">
                                </div>
                            ...
                            <button class="btn btn-primary btn-block next-btn form-control" type="submit"
