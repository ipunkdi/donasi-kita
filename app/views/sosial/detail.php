...
<body>
    ...
    <nav class="mt-5" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb mx-3">
            <li class="breadcrumb-item"><a href="<?= BASEURL; ?>/sosial">Sosial</a></li>
                ...
                <div class="web-version">
                    <div class="row">
                        <div class="col-md-12 my-2">
                            <h5><strong><?= $data['sos']['jenis']; ?></strong></h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="web-version">
                        <div class="col-md-8">
                            <img src="<?= BASEURL; ?>/img/foto-donasi-1.avif" alt="Foto Donasi" class="col-md-12">
                            <hr>
                                    ...
                                    <div class="tab-pane active" id="description">
                                        ...
                                        <div class="tab-pane active py-3" role="tabpanel" id="tab-description">
                                            <p><span
                                                    ...
                                                    style="color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;"><?= $data['sos']['deskripsi']; ?></span><br
                                                    style="box-sizing: inherit; color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;" /><br
                                                    style="box-sizing: inherit; color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;" /><span
                                                    style="color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;"><?= $data['sos']['deskripsi']; ?>.</span><br
                                                    style="box-sizing: inherit; color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;" /><br
                                                    style="box-sizing: inherit; color: #212121; font-family: 'Open Sauce One', sans-serif; font-size: 14px; background-color: #ffffff;" /><strong><span
                                                        ...
                                                        saudara-saudara kita <?= $data['sos']['jenis']; ?> dengan memanjatkan doa dan
                            ...
                            <div>
                                <div class="single-blog campaign-detail-donation">
                                    <div class="details">
                                        ...
                                        <?php } else { ?>
                                            <a href="<?= BASEURL; ?>/sosial/transaksi"
                                        ...
                                        <div class="fundraiser">
                                            <img src="<?= BASEURL; ?>/img/logo-poliwangi.png"
                                                alt>
                                            <a href="<?= BASEURL; ?>">
                                                <strong>
                                                    DONASIKITA
                                            ...
                                            <img src="https://ayobantu.com/assets/img/verify.webp" title="Verified User"
                                                style="width: 15px; height: 15px;" loading="lazy">
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
